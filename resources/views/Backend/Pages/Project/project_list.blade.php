...
<div class="page-header">
    ...
    <div class="page-btn">
        <a href="{{route('Add_Project')}}" class="btn btn-added"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-circle me-2">
            ...
            <tr class="text-center">
                ...
                <td class="action-table-data justify-content-center">
                    <div class="edit-delete-action">
                        ...
                        <a class="p-2" href="{{route('Add_Component', $item->id)}}">
